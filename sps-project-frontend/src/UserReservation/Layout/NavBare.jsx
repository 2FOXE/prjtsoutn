...
import { Home, Calendar, History, Menu, X, LogIn } from "lucide-react";
...
function NavBare() {
  ...
  return (
    <>
      <nav
        className={`sticky z  top-0  py-2.5  z-[48]  flex justify-center w-full transition-all duration-300 ${
          scrolled
            ? "bg-primary/5   backdrop-blur-md shadow-md"
            : "bg-transparent"
        }`}
      >
        <div className=" md:px-12 px-8   flex  items-center  w-full       justify-between">
          ...
          <div className="flex items-center">
            ...
            <span className="text-gray-950 md:text-blue-500 text-xl font-semibold ml-2">
              Hôtel de Luxe
            </span>
          </div>
          ...
          <div className="  hidden-nav  md:flex   space-x-4    items-center lg:space-x-12  ">
            <Link
              to="/user/"
              className="text-blue-500   text-md  hover:text-blue-400 flex items-center  !no-underline relative group"
            >
            ...
            <Link
              to="/reservations"
              className="text-blue-500  text-sm hover:text-blue-400 flex items-center   !no-underline  *: relative group"
            >
          ...
          <div className=" md:flex  hidden-nav    items-center  gap-4  md:gap-6">
            {user ? (
              <>
                ...
                />
                <button
                  className="text-lg text-white  rounded-md  raduis-button border-none bg-red-600 py-1 px-3 "
